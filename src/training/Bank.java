...
public class Bank {
	...
	public static void main(String[] args) {
		// Вариант -- 15 Кредиты. Сформировать набор предложений клиенту по целевым кредитам различных банков для оптимального выбора. Учитывать возможность досрочного погашения кредита и\или увеличения кредитной линии. Реализовать выбор и поиск кредита.
				List<Loan> loans= new ArrayList <>();
				
				loans.add(new Individuals(1,"Belarusbank",10,true, true, true));
				loans.add(new Individuals(2,"Belarusbank",24,true, false, false));
