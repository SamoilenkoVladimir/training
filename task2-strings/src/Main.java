...
public class Main {
	...
	public static void main(String[] args) {
		...
		//книга считывается из файла book1.txt, разбивается на предложения, в указанном предложении слова заменяются подстрокой
		//измененная книга записывается в файл output.txt  
